/* @ts-self-types="./oxidise_wasm.d.ts" */
...
export class StageRenderer {
    static __wrap(ptr) {
        const obj = Object.create(StageRenderer.prototype);
        obj.__wbg_ptr = ptr;
        StageRendererFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        StageRendererFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_stagerenderer_free(ptr, 0);
    }
    /**
     ...
     * @param {number} width
     * @param {number} height
     * @returns {Promise<StageRenderer>}
     */
    static create(canvas, width, height) {
        const ret = wasm.stagerenderer_create(canvas, width, height);
        return ret;
    }
    /**
    ...
    removeBillboard(id) {
        ...
        wasm.stagerenderer_removeBillboard(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * メッシュチャンクを取り外す。
     * @param {string} id
    ...
    removeMeshChunk(id) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.stagerenderer_removeMeshChunk(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * 現在のシーンをキャンバスへ描画してpresentする。
     */
    render() {
        const ret = wasm.stagerenderer_render(this.__wbg_ptr);
        if (ret[1]) {
     ...
     */
    resize(width, height) {
        wasm.stagerenderer_resize(this.__wbg_ptr, width, height);
    }
    /**
     ...
     * @param {number} far
     */
    setCamera(eye_x, eye_y, eye_z, look_x, look_y, look_z, fov_y_rad, near, far) {
        wasm.stagerenderer_setCamera(this.__wbg_ptr, eye_x, eye_y, eye_z, look_x, look_y, look_z, fov_y_rad, near, far);
    }
    /**
     ...
     * @param {number} b
     */
    setClearColour(r, g, b) {
        wasm.stagerenderer_setClearColour(this.__wbg_ptr, r, g, b);
    }
    /**
     ...
     */
    syncBillboard(id, source_key, rgba, width_px, height_px, world_x, world_y, world_z, yaw_rad, world_width, world_height, opacity) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        ...
        wasm.stagerenderer_syncBillboard(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, width_px, height_px, world_x, world_y, world_z, yaw_rad, world_width, world_height, opacity);
    }
    /**
     ...
     * @param {Uint8Array} colours
     * @param {Uint32Array} indices
     * @param {number} layer
     */
    uploadMeshChunk(id, vertices, colours, indices, layer) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF32ToWasm0(vertices, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(colours, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passArray32ToWasm0(indices, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        wasm.stagerenderer_uploadMeshChunk(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, layer);
    }
}
if (Symbol.dispose) StageRenderer.prototype[Symbol.dispose] = StageRenderer.prototype.free;
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_cceaf62d8d95e9f2: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen__convert__closures_____invoke__h48cec7a98a6b012f(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbg_stagerenderer_new: function(arg0) {
            const ret = StageRenderer.__wrap(arg0);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./oxidise_wasm_bg.js": import0,
    };
}

function wasm_bindgen__convert__closures_____invoke__h583aaaf058026732(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h583aaaf058026732(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h53375256f4907ff1(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h53375256f4907ff1(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h48cec7a98a6b012f(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h48cec7a98a6b012f(arg0, arg1, arg2, arg3);
}
...
const StageRendererFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_stagerenderer_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('oxidise_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();

/* @ts-self-types="./uxfd_rust_core_wasm.d.ts" */
 ...
 * @returns {any}
 */
export function build_solid_colour_vertex_scene(snapshot, media, canvas_width, canvas_height) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./uxfd_rust_core_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('uxfd_rust_core_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();

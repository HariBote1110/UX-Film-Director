...
const hksyCheckerGrid = (patch: Partial<HksyCheckerGridObject> = {}): HksyCheckerGridObject => ({
...
const getColorDotField = (patch: Partial<GetColorDotFieldObject> = {}): GetColorDotFieldObject => ({
...
const sphericalField = (patch: Partial<SphericalFieldObject> = {}): SphericalFieldObject => ({

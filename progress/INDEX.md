...
- [phase4c-inprocess-decode-integration.md](phase4c-inprocess-decode-integration.md) — Phase 4c Stage 1: `macos-video-decode` の decode.* RPC 面への統合（専用ワーカースレッド・pts順プリフェッチリング・自動フォールバック・実測で発見した先読み停止バグと修正）・実測3-4桁改善・Stage 2未着手の理由と計画（2026-07-20）

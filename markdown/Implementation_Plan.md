...
34. ✅ `P2` TimひょうたんTMをRust GeneratedGourd生成オブジェクトへ追加
35. ✅ `P2` Tim歯車をRust GeneratedGear生成オブジェクトへ追加
36. ✅ `P2` 93カスタムトラックバーをRust GeneratedTrackBar生成オブジェクトへ追加
37. ✅ `P2` 93パイシートグラフをRust GeneratedPieChart生成オブジェクトへ追加
...
271. AviUtlPackV4: 93 砕け散る球のPropertyPanelを実用調整UIへ詰める
`shattered_sphere` の既存編集欄を、スライダー＋数値入力の専用コントロールへ置き換える。
`Soft Burst`、`Fast Burst`、`Gravity Drop`、`Reset 93` の初期プリセットを追加し、

...
pub use schema::{
    ...
    PieChartSortMode, PositionKeyframe, Project, ProjectSize, PuzzleConnectorMode,
    PuzzlePieceObjectFields, RandomLineExObjectFields, RegionFrameObjectFields, SamplingMode,
    ScalarKeyframe, ShapeGradientFill, ShapeGradientKind, ShapeGradientScope, ShapeObjectFields,
    ShapeType, CircularArrowObjectFields, HoundstoothObjectFields, SimpleTubeObjectFields,

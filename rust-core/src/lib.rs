...
pub use schema::{
    ...
    Fps, GearObjectFields, GetColorDotFieldObjectFields, GourdObjectFields, HksyAnchorPoint,
    HksyCheckerGridObjectFields, HistogramObjectFields, ImageObjectFields, MediaKind,
